...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            <div className="absolute top-1/4 -left-20 w-72 h-72 bg-neonBlue/20 rounded-full blur-[100px]" />
            <div className="absolute bottom-1/4 -right-20 w-72 h-72 bg-fuchsia/20 rounded-full blur-[100px]" />
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl border border-white/10 z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-neonBlue to-fuchsia bg-clip-text text-transparent mb-2">KanbanFlow</h1>
                ...
                <p className="text-center text-slate-400 text-sm mt-6">
                    Don't have an account? <Link to="/register" className="text-neonBlue hover:text-fuchsia transition-colors font-semibold">Register here</Link>
                </p>
            </div>
        </div>
    );
